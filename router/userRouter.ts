...
import { createUser, deleteAllUser, deleteUser, getAllUser, getUser, signInUser, updateUserInfo, verifyUser } from "../controller/userController";
...
router.route("/:studentID/verify").get(verifyUser)
